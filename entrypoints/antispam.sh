...
# Amavisd
install -d -o ${SYS_USER_ROOT} -g ${SYS_GROUP_ROOT} -m 0777 ${AMAVISD_CUSTOM_CONF_DIR}
...
# SpamAssassin
install -d -o ${SYS_USER_ROOT} -g ${SYS_GROUP_ROOT} -m 0777 ${SPAMASSASSIN_CUSTOM_CONF_DIR}
