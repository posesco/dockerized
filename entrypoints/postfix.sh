...
install -d -o ${SYS_USER_ROOT} -g ${SYS_GROUP_ROOT} -m 0777 ${POSTFIX_CUSTOM_CONF_DIR}
install -d -o ${SYS_USER_ROOT} -g ${SYS_GROUP_ROOT} -m 0777 ${POSTFIX_CUSTOM_DISCLAIMER_DIR}
